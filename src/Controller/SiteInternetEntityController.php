...
class SiteInternetEntityController extends ControllerBase implements ContainerInjectionInterface {
  ...
  public function revisionShow($site_internet_entity_revision) {
    $site_internet_entity = $this->entityTypeManager()->getStorage('site_internet_entity')->loadRevision($site_internet_entity_revision);
      ...
      if ($revision->hasTranslation($langcode) && $revision->getTranslation($langcode)->isRevisionTranslationAffected()) {
        ...
        if ($latest_revision) {
          ...
          if ($revert_permission) {
            $links['revert'] = [
              'title' => $this->t('Revert'),
              'url' => $has_translations ? Url::fromRoute('entity.site_internet_entity.translation_revert', [
                'site_internet_entity' => $site_internet_entity->id(),
                'site_internet_entity_revision' => $vid,
                'langcode' => $langcode
