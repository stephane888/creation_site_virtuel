...
*   },
 *   links = {
 *     "canonical" = "/admin/structure/hbk_collection/{hbk_collection}",
...
class HbkCollection extends EditorialContentEntityBase implements HbkCollectionInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Collection by Habeuk entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Collection by Habeuk entity.'))
      ->setRevisionable(TRUE)
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Collection by Habeuk is published.'))
      ->setDisplayOptions('form', [
