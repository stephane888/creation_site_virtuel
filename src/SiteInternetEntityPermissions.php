...
/**
 * Provides dynamic permissions for Site internet entity of different types.
 *
 * @ingroup creation_site_virtuel
 *
 */
class SiteInternetEntityPermissions{
   ...
   *
   * @return array
   *   The SiteInternetEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (SiteInternetEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\creation_site_virtuel\Entity\SiteInternetEntity $type
   *   The SiteInternetEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(SiteInternetEntity $type) {
    $type_id = $type->id();
